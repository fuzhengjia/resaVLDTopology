 ...
 * this is designed for tomTrajDisplayTopFoxActDetWinDrawTraj, output for both fv and trajectories.
 */
public class traceAggFoxActDetWithTraj extends BaseRichBolt {
    ...
    public traceAggFoxActDetWithTraj(String traceGenBoltNameString, String flowTrackerName) {
