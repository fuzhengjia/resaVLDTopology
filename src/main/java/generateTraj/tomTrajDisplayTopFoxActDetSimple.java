...
public class tomTrajDisplayTopFoxActDetSimple {
    ...
    public static void main(String args[]) throws InterruptedException, AlreadyAliveException, InvalidTopologyException, FileNotFoundException {
        ...
        builder.setBolt(optFlowTracker, new optFlowTrackerFoxSimple(traceAggregator), getInt(conf, optFlowTracker + ".parallelism"))
        ...
        StormSubmitter.submitTopology("tTrajTopFoxActDetSim4Debug-" + init_counter + "-" + min_dis + "-" + w + "-" + h, conf, topology);
    }
}
