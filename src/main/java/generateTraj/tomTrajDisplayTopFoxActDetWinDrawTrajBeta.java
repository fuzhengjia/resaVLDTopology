 ...
 */
public class tomTrajDisplayTopFoxActDetWinDrawTrajBeta {
    ...
    public static void main(String args[]) throws InterruptedException, AlreadyAliveException, InvalidTopologyException, FileNotFoundException {
        ...
        builder.setBolt(featurePooling, new frameDisplayPolingFoxTrajBeta(), getInt(conf, featurePooling + ".parallelism"))
