 ...
 */
public class TomVideoStreamReceiverByteArrForLinux {
    ...
    public TomVideoStreamReceiverByteArrForLinux(String host, int port, String queueName) {
        this.host = host;
        this.port = port;
    ...
    public static void main(String args[]) {
        ...
        TomVideoStreamReceiverByteArrForLinux tvsr = new TomVideoStreamReceiverByteArrForLinux(args[0], Integer.parseInt(args[1]), args[2]);
        try {
            if (args.length == 4){
