 ...
 */
public class testPatchProcBolt extends BaseRichBolt {
    ...
    public void prepare(Map map, TopologyContext topologyContext, OutputCollector outputCollector) {
        ...
        patchQueue = new LinkedHashMap<Integer, Queue<Serializable.PatchIdentifier>>(){
            @Override
            protected boolean removeEldestEntry(Map.Entry<Integer, Queue<Serializable.PatchIdentifier>> eldest) {
                return size() > MaxSizeOfReceivedUpdatesFrom;
            }
        };

        templateQueue = new LinkedHashMap<Integer, Queue<LogoTemplateUpdate>>(){
            @Override
            protected boolean removeEldestEntry(Map.Entry<Integer, Queue<LogoTemplateUpdate>> eldest) {
                return size() > MaxSizeOfReceivedUpdatesFrom;
            }
        };
        */
